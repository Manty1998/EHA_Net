...
parser.add_argument('--root_path', type=str, default='data_split/LA/', help='Name of Experiment')
...
snapshot_path = 'E:/LMT_Code/BCP-main2/model/BCP/LA_BCP_8_labeled/self_train'
####test_save_path = "./model/BCP/LA_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
test_save_path = "./model/BCP/LA_BCP_8_labeled/predictions"
num_classes = 2
