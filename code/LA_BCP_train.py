...
# from PHDNet.networks import *  ###风格化模块
#
...
# parser.add_argument('--pre_max_iteration', type=int,  default=2000, help='maximum pre-train iteration to train')     #default=2000
# parser.add_argument('--self_max_iteration', type=int,  default=7500, help='maximum self-train iteration to train')  #default=15000
# parser.add_argument('--max_samples', type=int,  default=80, help='maximum samples to train')
# parser.add_argument('--labeled_bs', type=int, default=1, help='batch_size of labeled data per gpu')  #default = 4
# parser.add_argument('--batch_size', type=int, default=2, help='batch_size per gpu')   #default = 4
...
#             mixl_img0 = img_a * img_mask + unimg_a * (1 - img_mask)
#             mixl_img = adain(mixl_img0, img_b)  #####   空间风格化操作
#
#
#             # mixu_img = unimg_b * img_mask + img_b * (1 - img_mask)
#             mixu_img0 = unimg_b * img_mask + img_b * (1 - img_mask)
#             mixu_img = adain(mixu_img0, unimg_a)  #####   空间风格化操作
#
...
#     shutil.copy('E:/LMT_Code/BCP-main2/code/LA_BCP_train.py', self_snapshot_path)
#     # -- Pre-Training
...
parser.add_argument('--self_max_iteration', type=int, default=7500, help='maximum self-train iteration to train')
parser.add_argument('--max_samples', type=int, default=80, help='maximum samples to train')
...
def pre_train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            volume_batch0 = img_a * img_mask + img_b * (1 - img_mask)
            volume_batch = adain_fg(volume_batch0, img_b, img_mask)     #####   空间风格化
